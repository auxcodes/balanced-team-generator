...
const ConfirmSelection: React.FC<ConfirmSelectionProps> = ({
  setErrorMessage,
  setTeams,
  selectedPlayers,
  teamCount,
      ...
      <div className="sub-container">
        <div className="team-options">
          <div className="info-row">
            <label className="player-count-label">Number of Teams: {teamCount}</label>
            <button className="generate-btn" onClick={handleGenerateTeams}>
              Generate Teams
            </button>
          </div>
        </div>
